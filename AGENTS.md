...
edit the canonical checkout** (`${WORKSPACE_ROOT}/agent-packages/agents/<repo>`) — a
...
git -C agent-packages/agents/<repo> worktree add ${WORKTREE_ROOT}/<repo>/<branch> -b <branch>
```
